...
export const LEARNING_PATHS: LearningPath[] = [
  {
    ...
    nodes: [
      ...
      {
        id: 'ai-vector-db',
        courseId: 'course-vector-databases',
        label: 'Vector search',
        summary: 'Use embeddings, metadata filters, hybrid search, and reranking for semantic retrieval.',
        prereqCourseIds: ['course-rag'],
        skills: ['embeddings', 'ANN indexes', 'hybrid search', 'reranking'],
      },
      {
        id: 'ai-agents',
  ...
  },
  {
    ...
    nodes: [
      ...
      {
        id: 'cloud-iac',
        courseId: 'course-iac-terraform-opentofu',
        label: 'Infrastructure as Code',
        summary: 'Deliver infrastructure with declarative config, state, modules, plans, and policy checks.',
        prereqCourseIds: ['course-cicd'],
        skills: ['Terraform', 'OpenTofu', 'state', 'policy-as-code'],
      },
      {
        id: 'cloud-serverless',
      ...
      },
      {
        ...
        courseId: 'course-service-mesh',
        label: 'Service mesh',
        summary: 'Control service-to-service traffic, mTLS, canaries, retries, and observability.',
        prereqCourseIds: ['course-kubernetes'],
        skills: ['mTLS', 'traffic policy', 'canary', 'resilience'],
      },
      {
        id: 'cloud-edge',
        courseId: 'course-edge-computing',
        label: 'Edge apps',
        summary: 'Move compute closer to users with CDN caching, edge functions, and fallback paths.',
        prereqCourseIds: ['course-azure'],
        skills: ['CDN', 'edge workers', 'cache keys', 'latency'],
      },
      {
        id: 'cloud-finops',
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        courseId: 'course-passkeys-webauthn',
        label: 'Passkeys',
        summary: 'Implement phishing-resistant WebAuthn login with passkeys and recovery strategy.',
        prereqCourseIds: ['course-oauth2'],
        skills: ['WebAuthn', 'FIDO2', 'public keys', 'account recovery'],
      },
      {
        id: 'security-jwt',
        courseId: 'course-jwt',
      ...
      },
      {
        ...
        courseId: 'course-zero-trust',
        label: 'Zero trust',
        summary: 'Replace implicit network trust with identity, device, policy, and continuous authorization.',
        prereqCourseIds: ['course-authz'],
        skills: ['identity-first', 'policy', 'segmentation', 'least privilege'],
      },
      {
        id: 'security-privacy',
        courseId: 'course-privacy-engineering',
        label: 'Privacy engineering',
        summary: 'Design systems with minimization, consent, retention, deletion, and privacy risk controls.',
        prereqCourseIds: ['course-authz'],
        skills: ['data inventory', 'retention', 'deletion', 'privacy risk'],
      },
      {
        id: 'security-https',
